...
from ipss.base_selectors import fit_l1_classifier, fit_l1_regressor, fit_mcp_regressor, fit_scad_regressor, fit_adaptive_lasso
...
def selector_and_args(selector, selector_args):
	selectors = {'logistic_regression':fit_l1_classifier, 'lasso':fit_l1_regressor, 'mcp':fit_mcp_regressor, 
		'scad':fit_scad_regressor, 'adaptive_lasso':fit_adaptive_lasso}
