...
from ipss.helpers import (check_response_type, compute_alphas, compute_efp_scores, compute_q_list, compute_qvalues, integrate, 
	selection, selector_and_args)

#--------------------------------
# Main function
#--------------------------------
def select(X, y, ipss_args=None, ss_args=None, B=50, selector='l1', selector_args=None, n_alphas=None, standardize_X=None, center_y=None, n_jobs=1):
